...
// [quantityInput, unitPriceInput].forEach(el => el.addEventListener('input', calculateTotals));
...
// // No AJAX submission needed; form will submit naturally
// calculateTotals();
...
// [quantityInput, unitPriceInput, transportCheckbox].forEach(el => {
...
// [quantityInput, unitPriceInput, addSalesForm.customerName, addSalesForm.salesAgent].forEach(input => {
...
// });
// productNameSelect.addEventListener("change", () => errorFields.productName.textContent = "");
// transportCheckbox.addEventListener("change", calculateTotals);
...
//     transportProvided: transportCheckbox.checked
//   };
